...
import sample_product from '../resources/images/image.png'
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                <img src={sample_product} alt='sample-product'></img>
                      ...
                      <div class = "item">
                        <Grid container spacing={0}>
                          <Grid item xs md={1} lg={2} border={1} justifyItems={'center'} alignItems={'center'} height={100}> 
                            <Item>
                                <img src={sample_product} width={80} height={80} align={'center'} justify={'center'} alt='sample-product'></img>
